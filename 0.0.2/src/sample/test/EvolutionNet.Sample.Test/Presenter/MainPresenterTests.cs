...
//		private DynamicMock view;
		...
		private MainPresenterTest presenter;
...
//			view = new DynamicMock("MainView", typeof(IWinMainView));
			view = new MainView();
			presenter = new MainPresenterTest(view);
		}
...
//		}
		...
		private class MainPresenterTest : MainPresenter
		{
			public MainPresenterTest(IMainView view) : base(view)
			{
			}
