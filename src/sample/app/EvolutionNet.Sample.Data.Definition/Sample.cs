...
namespace EvolutionNet.Sample.Data.Definition {
    ...
    public partial class Territory : SqlServerModel, IModel<string>, INotifyPropertyChanged {
        ...
        [HasAndBelongsToMany(typeof(Employee), ColumnRef="EmployeeID", ColumnKey="TerritoryID", Schema="dbo", Table="EmployeeTerritories")]
    ...
    public partial class CustomerDemographics : SqlServerModel, IModel<string>, INotifyPropertyChanged {
        ...
        [HasAndBelongsToMany(typeof(Customer), ColumnRef="CustomerID", ColumnKey="CustomerTypeID", Schema="dbo", Table="CustomerCustomerDemo")]
