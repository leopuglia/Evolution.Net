...
{
	public class TestControlHelper : IControlHelper
	{
		...
		public TestControlHelper(IControlView view)
		{
...
//		}
		...
		public static TestControlHelper CreateInstance(IControlView view)
		{
		...
		private class Nested
		{
			...
			internal static TestControlHelper CreateLocalInstance(IControlView view)
			{
				return new TestControlHelper(view);
			}
		}
